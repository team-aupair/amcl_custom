...
class AMCLLaser : public AMCLSensor
{
  ...
  public: virtual bool UpdateSensor(pf_t *pf, AMCLSensorData *data, double x, double y, double r);
  ...
  private: static double BeamModel(AMCLLaserData *data, 
                                   pf_sample_set_t* set);
  // Determine the probability for the given pose
  private: static double LikelihoodFieldModel(AMCLLaserData *data, pf_sample_set_t* set, double x, double y, double r, int use_orb);
